            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Sifre Dogrula" required=""/>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" name="agree-term" id="agree-term" class="agree-term" />
                                <label for="agree-term" class="label-agree-term"><span><span></span></span>Kabul Ediyorum  <a href="#" class="term-service">Kullanim Sartlari</a></label>
                            </div>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="{{ route('login') }}" class="signup-image-link"><b>Zaten üyeyim</b></a>
                    </div>
                </div>
            </div>
        </section>
